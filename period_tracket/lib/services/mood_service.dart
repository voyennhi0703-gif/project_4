...
class MoodService {
  ...
  static Future<List<MoodData>> getMoodDataForLastWeek() async {
    final prefs = await SharedPreferences.getInstance();
    ...
    for (int i = 6; i >= 0; i--) {
      ...
      final moodDataJson = prefs.getString('mood_$dateKey');
      
      if (moodDataJson != null) {
        final moodData = MoodData.fromJson(jsonDecode(moodDataJson));
