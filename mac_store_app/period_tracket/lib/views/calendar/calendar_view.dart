...
class _CalendarViewState extends State<CalendarView> {
  ...
  Color getDayColor(DateTime? date, DataManager dataManager) {
    ...
    switch (data['type']) {
      case 'period':
        if (data['flow'] == 'heavy') return TColor.rosePink;
        if (data['flow'] == 'medium') return TColor.blushPink;
        return TColor.softPink;
      case 'predicted-period':
        return TColor.softPink.withOpacity(0.3);
      case 'ovulation':
        return TColor.coral;
      case 'predicted-ovulation':
        return TColor.coral.withOpacity(0.3);
      case 'fertile':
        return TColor.blushPink;
      case 'predicted-fertile':
        return TColor.blushPink.withOpacity(0.3);
      default:
    ...
    return Consumer<DataManager>(
      builder: (context, dataManager, child) {
        ...
        return Scaffold(
          ...
          body: buildMainCalendar(dataManager),
        );
      },
    );
  }
